 ...
 * 
 */
@WebServiceClient(name = "MyServiceImplService", targetNamespace = "http://service.bobtest.com/", wsdlLocation = "http://localhost:10003/ns?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYSERVICEIMPLSERVICE_QNAME = new QName("http://service.bobtest.com/", "MyServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:10003/ns?wsdl");
    ...
    public IMyService getMyServiceImplPort() {
        return super.getPort(new QName("http://service.bobtest.com/", "MyServiceImplPort"), IMyService.class);
    }
    ...
    public IMyService getMyServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.bobtest.com/", "MyServiceImplPort"), IMyService.class, features);
    }
